package loqor.skipstones.core.datagen.datagen_providers;

import loqor.skipstones.Skipstones;
import loqor.skipstones.core.datagen.LanguageType;
...
public class SkipstonesLanguageProvider extends FabricLanguageProvider {
    ...
    public SkipstonesLanguageProvider(FabricDataOutput dataOutput, LanguageType languageType) {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        dataGenerator.getModContainer().findPath("assets/" + Skipstones.MOD_ID + "/lang/" + languageType.name().toLowerCase() + ".existing.json").ifPresent(existingFilePath -> {
            try {
    ...
    private String getTranslationKeyForNeptuneItemGroup(ItemGroup itemGroup) {
        return itemGroup.getDisplayName().toString();
    }
